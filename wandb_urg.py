...
def main():
    ...
    parser.add_argument('--project', type=str, default="USGen", help='Name of the dataset to log metrics for.')
    ...
    parser.add_argument('--logsota', type=str, default='false', help='result path')
    ...
    if args.logsota == 'true':
        ...
        for i in range(0,100):
                    wandb.log({
                        "test_Mammary_BLEU_1": 0.761,
                        "test_Liver_BLEU_1": 0.872,
                        "test_Thyroid_BLEU_1": 0.729,
                        "test_Mammary_BLEU_4": 0.640,
                        "test_Liver_BLEU_4": 0.813,
                        "test_Thyroid_BLEU_4": 0.568,
                    })
        wandb.finish()
        return
    ...
    while True:
        if os.path.exists(log_file_path):
            ...
            for _, row in df.iterrows():
                wandb.log({
                    "test_Mammary_BLEU_1": row['test_Mammary_BLEU_1'],
                    "test_Liver_BLEU_1": row['test_Liver_BLEU_1'],
                    "test_Thyroid_BLEU_1": row['test_Thyroid_BLEU_1'],
                    "test_Mammary_BLEU_4": row['test_Mammary_BLEU_4'],
                    "test_Liver_BLEU_4": row['test_Liver_BLEU_4'],
                    "test_Thyroid_BLEU_4": row['test_Thyroid_BLEU_4'],
